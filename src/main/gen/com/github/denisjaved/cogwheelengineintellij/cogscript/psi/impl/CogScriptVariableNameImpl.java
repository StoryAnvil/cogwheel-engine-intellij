...
public class CogScriptVariableNameImpl extends CogScriptNamedVariableImpl implements CogScriptVariableName {

  public CogScriptVariableNameImpl(@NotNull ASTNode node) {
    super(node);
  }
